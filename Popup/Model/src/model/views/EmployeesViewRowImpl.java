...
public class EmployeesViewRowImpl extends ViewRowImpl {
    ...
    protected enum AttributesEnum {
        ...
        protected int index() {
            return EmployeesViewRowImpl.AttributesEnum.firstIndex() + ordinal();
        }
        ...
        protected static int count() {
            return EmployeesViewRowImpl.AttributesEnum.firstIndex() + EmployeesViewRowImpl.AttributesEnum
                                                                                          .staticValues().length;
        }

        protected static final AttributesEnum[] staticValues() {
            if (vals == null) {
                vals = EmployeesViewRowImpl.AttributesEnum.values();
            }
            return vals;
        }
    }
    ...
    public static final int JOBSVIEW = AttributesEnum.JobsView.index();
    ...
    /**
     * Gets the associated <code>RowIterator</code> using master-detail link JobsView.
     */
    public RowIterator getJobsView() {
        return (RowIterator) getAttributeInternal(JOBSVIEW);
    }
